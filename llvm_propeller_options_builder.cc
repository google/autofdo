...
PropellerOptionsBuilder& PropellerOptionsBuilder::SetBinaryName(const std::string& value) {
  data_.set_binary_name(value);
  return *this;
}

PropellerOptionsBuilder& PropellerOptionsBuilder::AddPerfNames(const std::string& value) {
  data_.add_perf_names(value);
  return *this;
}

PropellerOptionsBuilder& PropellerOptionsBuilder::SetClusterOutName(const std::string& value) {
  data_.set_cluster_out_name(value);
  return *this;
}

PropellerOptionsBuilder& PropellerOptionsBuilder::SetSymbolOrderOutName(const std::string& value) {
  data_.set_symbol_order_out_name(value);
  return *this;
}

PropellerOptionsBuilder& PropellerOptionsBuilder::SetProfiledBinaryName(const std::string& value) {
...
PropellerOptionsBuilder& PropellerOptionsBuilder::SetCfgDumpDirName(const std::string& value) {
