...
DEFINE_string(propeller_symorder, "", "Symbol ordering file output file name");
DEFINE_string(gcov, "",
...
int main(int argc, char **argv) {
  ...
  if (FLAGS_format == "text") {
    ...
    PropellerProfWriter PPWriter(FLAGS_binary, FLAGS_profile, FLAGS_out, FLAGS_propeller_symorder);
