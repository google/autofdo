#ifndef AUTOFDO_LLVM_PROPELLER_FUNCTION_CLUSTER_INFO_H_
#define AUTOFDO_LLVM_PROPELLER_FUNCTION_CLUSTER_INFO_H_
...
#endif  // AUTOFDO_LLVM_PROPELLER_FUNCTION_CLUSTER_INFO_H_
